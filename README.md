...
Captor Iris Bond baseras på investeringar främst i säkerställda bostadsobligationer, men också en del statsobligationer och liknande – det är fondens **obligationsben** (de fysiska obligationsinnehaven, med relativt kort löptid). Ovanpå det används räntederivat (swappar och swaptions) för att förlänga och upprätthålla positioner mot svenska räntor med lång löptid.
...
Regressionen ger då fondens duration (~9,7 år realiserat, vilket är lägre än de ca 11 år som anges, se förbehåll nedan), obligationsbenets spread-känslighet och en carry-koefficient nära 1. Passningen är god (modellens simulerade "fond" har en korrelationsfaktor på ca 0,97 jämfört med den riktiga fonden sedan 2017).
