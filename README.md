...
Regressionen ger då fondens duration (~9,7 år realiserat, vilket är lägre än de ca 11 år som anges, se förbehåll nedan), kassabenets spread-känslighet och en carry-koefficient nära 1. Passningen är god (modellens simulerade "fond" har en korrelationsfaktor på ca 0,97 jämfört med den riktiga fonden sedan 2017).
